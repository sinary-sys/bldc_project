...
void SetCap4Mode(void)
{
  ...
  ECap4Regs.ECEINT.all=0x0000;//stop all interrupt
  ECap4Regs.ECCLR.all=0xFFFF;//clare all flag
  ECap4Regs.ECCTL2.bit.TSCTRSTOP = EC_RUN;// 启动
  ECap4Regs.ECEINT.bit.CEVT1=1;// Enable cevt1 interrupt
  ECap4Regs.ECEINT.bit.CEVT2=1;// Enable cevt2 interrupt
  ECap4Regs.ECEINT.bit.CEVT3=1;// Enable cevt3 interrupt
  ECap4Regs.ECEINT.bit.CEVT4=1;// Enable cevt4 interrupt
}
//===========================================================================
// End of file.
//===========================================================================
